...
# SETTINGS
mpc_cmd="mpc --host=$HOME/.local/share/mpd/mpd.socket"
...
padding_top="$(cat "$arg_file" | cut -d ' ' -f1)"
padding_bottom="$(cat "$arg_file" | cut -d ' ' -f2)"
padding_right=0
max_width=30
