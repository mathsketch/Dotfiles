# Generated by Powerlevel10k configuration wizard on 2022-07-06 at 01:03 CST.
...
() {
  ...
  function prompt_my_lf() {
    [[ -n "$LF_LEVEL" ]] && p10k segment -b cyan -f black -i ' '
  }
  function prompt_my_proxy() {
    printenv http_proxy >/dev/null && p10k segment -b 5 -f black -i ' '
  }
